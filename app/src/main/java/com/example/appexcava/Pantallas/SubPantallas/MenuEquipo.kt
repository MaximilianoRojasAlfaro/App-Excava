...
@Composable
fun MenuEquipo(navController: NavController){
    ...
    Scaffold(
        ...
        topBar = {
            ...
            TopAppBar(
                ...
                title = {
                    Text(text = "Equipos", fontSize = 23.sp, fontWeight = FontWeight.Bold, modifier = Modifier.fillMaxWidth(fraction = 0.85f), textAlign = TextAlign.Center)
                },
        ...
        Box(
            ...
            Column(
                ...
                BotonNavegacion(destino = "agregarEquipo", texto = "Nuevo", navController = navController, color = Color.Magenta)
                ...
                BotonNavegacion(destino = "eliminarEquipo", texto = "Eliminar", navController = navController, color = Color.Red)
            }
        }
    }
}